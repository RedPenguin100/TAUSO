...
def test_rbp_complexity_features_regression(sampled_base_data, gene_to_data, rbp_assets, dataframe_regression, data_regression):
    """
    ...
    feature_payload = {
        "individual_features": individual_features.to_dict('records') if isinstance(individual_features,
                                                                                    pd.DataFrame) else individual_features,
        "global_features": global_features.to_dict('records') if isinstance(global_features,
                                                                            pd.DataFrame) else global_features,
    }
