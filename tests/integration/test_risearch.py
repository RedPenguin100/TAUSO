# import pytest
#
# from notebooks.external.risearch.RIsearch1.numpy_to_csv import dsm_variable_to_csv
# from tauso.hybridization.fast_hybridization import get_trigger_mfe_scores_by_risearch, Interaction, get_mfe_scores
# from tests.integration.modified_dsm import make_dsm_dna_rna
# from tauso.util import get_antisense
# from tests.integration.target_finder import get_gfp_first_exp
#
#
# def test_risearch_gfp_modified(data_regression):
#     # --- 1. Setup ---
#     # Ideally, move these to a pytest fixture if they are expensive or used across multiple tests.
#     dsm_variable_to_csv()
#     make_dsm_dna_rna()
#
#     # --- 2. Data Preparation ---
