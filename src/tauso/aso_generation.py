...
from tauso.data.consts import SEQUENCE, CANONICAL_GENE, MODIFICATION, CHEMICAL_PATTERN, CELL_LINE_ORGANISM, \
    CELL_LINE_DEPMAP, CELL_LINE
...
from tauso.populate.populate_codon_usage import populate_tai, populate_cai, populate_enc
...
from tauso.populate.populate_rbp import populate_functional_features, populate_rbp_region
from tauso.features.rbp.rbp_annotations import rbp_role_map_strict
from tauso.data.data import get_paths, get_data_dir, load_db
