...
MODIFICATION_FEATURE_TO_CALCULATION = {
    ...
    "mod_type_count": lambda row: compute_mod_type_count(row[CHEMICAL_PATTERN]),
    ...
    "mod_block_count": lambda row: compute_mod_block_count(row[CHEMICAL_PATTERN]),
    "mod_max_block_length": lambda row: compute_mod_max_block_length(row[CHEMICAL_PATTERN]),
    "mod_char_entropy": lambda row: compute_mod_char_entropy(row[CHEMICAL_PATTERN]),
    "mod_dominant_mod_fraction": lambda row: compute_dominant_mod_fraction(row[CHEMICAL_PATTERN]),
    "mod_evenness": lambda row: compute_mod_evenness(row[CHEMICAL_PATTERN]),
    "mod_symmetry_score": lambda row: compute_mod_symmetry_score(row[CHEMICAL_PATTERN]),
    "mod_skew_index": lambda row: compute_mod_skew_index(row[CHEMICAL_PATTERN]),
    "mod_mean_gap": lambda row: compute_mod_mean_gap(row[CHEMICAL_PATTERN]),
    "mod_local_density_max": lambda row: compute_mod_local_density_max(row[CHEMICAL_PATTERN]),
    "mod_in_core": lambda row: compute_mod_in_core(row[CHEMICAL_PATTERN]),
    "mod_longest_repeat_run": lambda row: compute_mod_longest_repeat_run(row[CHEMICAL_PATTERN]),
    "mod_adjacent_pair_count": lambda row: compute_mod_adjacent_pair_count(row[CHEMICAL_PATTERN]),
    "mod_strong_repeat_group_count": lambda row: compute_mod_strong_repeat_group_count(row[CHEMICAL_PATTERN]),
}
