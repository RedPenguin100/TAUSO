...
import numpy as np
import pandas as pd
from ..consts_dataframe import SENSE_START, SENSE_LENGTH, CANONICAL_GENE
...
def calculate_sense_accessibility_batch(aso_dataframe, gene_to_data, batch_size=1000, flank_size=FLANK_SIZE,
